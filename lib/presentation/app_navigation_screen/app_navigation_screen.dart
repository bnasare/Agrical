...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapDashBoardMonitoringContainer(
                                                  context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill9,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "DashBoard-Monitoring - Container",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  textAlign:
  ...
  onTapCapture(BuildContext context) {
  ...
  onTapH(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.hScreen);
  }

  /// Navigates to the oScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the oScreen.
  onTapO(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.oScreen);
  }

  /// Navigates to the mScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the mScreen.
  onTapM(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.mScreen);
  }
  ...
  onTapRecaptureSave(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.recaptureSaveScreen);
  }

  /// Navigates to the predictionScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the predictionScreen.
  onTapPrediction(BuildContext context) {
  ...
  onTapPredictFruits(BuildContext context) {
  ...
  onTapPredictRipe(BuildContext context) {
  ...
  onTapPredictSpoil(BuildContext context) {
  ...
  onTapDashBoardMonitoringContainer(BuildContext context) {
